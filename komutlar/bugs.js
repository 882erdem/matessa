...
let channel = bot.channels.get("761592294268338228")//bug repot kanal id'i
...
message.channel.send(" <a:matassa_tik:761507821258407956> **| Bug Report Başarı İle İletildi.**")
channel.send(embed)
