...
//knk ayarlar.jsona egkerti
client.login(ayarlar.token);//o zaman dokunma bir kere daha dokunursan giderim
//---------------------OTOROL BAŞLAR-----------------------------------\\
...
client.channels.get(otorolkanal).send(
    ...
    .setColor('GREEN')
    .setTitle('Matessa | otorol sistemi')
    .setDescription(`${endlesscode} sunucuya katıldı rol verildi <a:B_Pikachu:761343460506206270> `)
)
